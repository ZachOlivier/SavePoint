...
public class introScript : MonoBehaviour {
	...
	void Update () {
		...
		if (part == 2) {
			...
			message.display2Decision("Greg Clemens", "Main Character", 100);
		}
		...
		if (part == 6) {
			...
			message.display2Decision("Jill", "Greg's Wife", 100);
		}
		...
		if (part == 9) {
			...
			message.display2Decision("Angie", "Greg's Daughter", 100);
		}
